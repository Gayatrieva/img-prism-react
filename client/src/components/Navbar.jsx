  ...
  return (
    ...
    <div className="flex justify-between items-center">
        ...
        <ul className="flex gap-5 text-lg font-semibold text-gray-400 ml-5 sm:ml-0">
            ...
            <Link to="/" className="hover:text-black cursor-pointer sm:p-2">Log in</Link>
            <Link to="/login" className="hover:text-black cursor-pointer sm:p-2">Sign up</Link>
            <Link to="/signup" className="hover:text-black cursor-pointer sm:p-2"></Link>
        </ul>
    </nav>
